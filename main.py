...
if __name__ ==  '__main__':
    file_path = r"C:\development\IterPoly_GUI\data_folder\lamp_on\side_a_fast_data.bin"
    ...
    apply_calibrations(frames[2:5], r'C:\development\IterPoly_GUI\calibrations\adc0_side_a_calibration.json')
    plot_several_signals(frames[2:3], 7)